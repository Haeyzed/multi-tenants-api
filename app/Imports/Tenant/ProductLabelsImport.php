...
class ProductLabelsImport implements SkipsOnFailure, ToModel, WithHeadingRow, WithValidation
{
    use SkipsFailures;
     ...
     */
    public function model(array $row): ProductLabel
    {
        ...
        return ProductLabel::updateOrCreate($lookup, $attributes);
    }
