...
namespace App\Exports\Central\Concerns;
 ...
 */
abstract class BaseCentralExport implements FromCollection, WithHeadings, WithMapping
{
    /**
    ...
    protected function resolvedColumns(): array
    {
        ...
        $keys = $this->columns ?? self::availableColumns();
        $resolved = [];
