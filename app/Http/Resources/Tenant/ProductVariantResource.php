...
class ProductVariantResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'is_sale_active' => $this->isSaleActive(),
            'use_warehouse_pricing' => (bool) $this->use_warehouse_pricing,
            'weight' => $this->weight,
            'length' => $this->length,
            'width' => $this->width,
            'height' => $this->height,
            ...
            'warehouse_prices' => VariantWarehousePriceResource::collection($this->whenLoaded('warehousePrices')),
