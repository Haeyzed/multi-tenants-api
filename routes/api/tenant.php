...
Route::prefix('v1/tenant')->group(function (): void {
    ...
    Route::middleware('auth:sanctum')->group(function (): void {
        ...
        Route::prefix('products')->group(function (): void {
            ...
            Route::put('{product}/videos', [ProductController::class, 'syncVideos']);
            Route::post('{product}/duplicate', [ProductController::class, 'duplicate']);
            Route::get('{product}/faqs', [ProductController::class, 'faqs']);
            Route::post('{product}/faqs', [ProductController::class, 'storeFaq']);
            Route::put('{product}/faqs/{faq}', [ProductController::class, 'updateFaq']);
            Route::delete('{product}/faqs/{faq}', [ProductController::class, 'destroyFaq']);
            Route::get('{product}/documents', [ProductController::class, 'documents']);
            Route::post('{product}/documents', [ProductController::class, 'storeDocument']);
            Route::put('{product}/documents/{document}', [ProductController::class, 'updateDocument']);
            Route::delete('{product}/documents/{document}', [ProductController::class, 'destroyDocument']);
            Route::get('{product}/reviews', [ProductController::class, 'reviews']);
            Route::put('{product}/reviews/{review}', [ProductController::class, 'updateReview']);
            Route::delete('{product}/reviews/{review}', [ProductController::class, 'destroyReview']);
            Route::get('{product}/questions', [ProductController::class, 'questions']);
            Route::put('{product}/questions/{question}', [ProductController::class, 'updateQuestion']);
            Route::delete('{product}/questions/{question}', [ProductController::class, 'destroyQuestion']);
